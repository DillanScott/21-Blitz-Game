...
class Board:
    ...
    def output(self):
        ...
        print(f'|{self.col1.total}|             |{self.col2.total}|             |{self.col3.total}|             |{self.col4.total}|',
              f'|{self.col1.cards[0]}|          |{self.col2.cards[0]}|          |{self.col3.cards[0]}|          |{self.col4.cards[0]}|',
              f'|{self.col1.cards[1]}|          |{self.col2.cards[1]}|          |{self.col3.cards[1]}|          |{self.col4.cards[1]}|',
              f'|{self.col1.cards[2]}|          |{self.col2.cards[2]}|          |{self.col3.cards[2]}|          |{self.col4.cards[2]}|',
              f'|{self.col1.cards[3]}|          |{self.col2.cards[3]}|          |{self.col3.cards[3]}|          |{self.col4.cards[3]}|',
              f'|{self.col1.cards[4]}|          |{self.col2.cards[4]}|          |{self.col3.cards[4]}|          |{self.col4.cards[4]}|', 
              sep='\n')
